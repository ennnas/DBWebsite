...
<?php
  ...
  $query = "select count(*) as num, url from visita join sito_web on sito=codice where sito in 
  (SELECT s.codice from sito_web s where s.cliente=".$_SESSION['id'].") group by url";
  $stmt = mysqli_prepare($conn, $query);
  $result3 = array('visitatori' => array(), 'sito' => array());
  if ($stmt) {
    mysqli_stmt_execute($stmt);
    mysqli_stmt_bind_result($stmt, $num, $sito);
      while (mysqli_stmt_fetch($stmt)) {
          $result3['visitatori'][] = $num;
          $result3['sito'][] = (string)$sito;
      }
...
<nav class="w3-sidebar w3-bar-block w3-small w3-hide-small w3-center">
  ...
  <a href="HomeCliente.html" class="w3-bar-item w3-button w3-padding-large w3-hover-black">
    <i class="fa fa-home w3-xxlarge"></i>
    <p>HOME</p>
  </a>
  <a href="StatsCliente.php" class="w3-bar-item w3-button w3-padding-large w3-black">
...
<div class="w3-top w3-hide-large w3-hide-medium" id="myNavbar">
  <div class="w3-bar w3-black w3-opacity w3-hover-opacity-off w3-center w3-small">
    <a href="HomeCliente.html" class="w3-bar-item w3-button" style="width:25% !important">HOME</a>
    <a href="StatsCliente.php" class="w3-bar-item w3-button" style="width:25% !important">STATS</a>
...
<div class="w3-padding-large" id="main">
  ...
  <header class="w3-container w3-padding-32 w3-center w3-black" id="home">
    <h1 class="w3-jumbo"><span class="w3-hide-small">Client</span> Area</h1>
